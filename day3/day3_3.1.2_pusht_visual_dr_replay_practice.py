#!/usr/bin/env python3
"""Day3-3.1.2 PRACTICE: PushT visual domain randomization after re-rendering.
...
Run from project root:
    $ISAACLAB_PATH/isaaclab.sh -p day3/day3_3.1.2_pusht_visual_dr_replay_practice.py \
...
# 4. 메인 함수
# ============================================================================
# PushT visual DR replay 실습 파이프라인을 실행합니다.
def main() -> None:
    rng = random.Random()
