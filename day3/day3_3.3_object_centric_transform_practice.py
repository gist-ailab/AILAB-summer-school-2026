#!/usr/bin/env python3
"""Day3-3.3 PRACTICE: Object-centric approach trajectory transform from HDF5.
...
parser = argparse.ArgumentParser(description="PRACTICE: replay an HDF5 approach segment toward randomly moved T-bars.")
