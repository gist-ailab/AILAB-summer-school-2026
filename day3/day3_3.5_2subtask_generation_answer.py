#!/usr/bin/env python3
"""Day3-3.5 ANSWER: 2-subtask source and mimic generation.
...
parser = argparse.ArgumentParser(description="2-subtask source + mimic generation.")
...
def create_2subtask_source(input_file: str, output_file: str, num_demos: int = 0) -> None:
    ...
    with h5py.File(output_file, "a") as f:
        ...
        for name in selected_demo_names(f["data"], num_demos):
            ...
            recreate_h5_dataset(signals, "object_lifted_from_height", step_signal(length, step))
...
# ============================================================================
# 2-subtask source 생성 후 mimic generation을 실행합니다.
def main():
