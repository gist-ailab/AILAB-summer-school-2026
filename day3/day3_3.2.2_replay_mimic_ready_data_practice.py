#!/usr/bin/env python3
"""Day3-3.2.2 PRACTICE: State replay and mimic-ready datagen_info recording.
...
parser = argparse.ArgumentParser(description="Practice: restore saved states and record isaaclab_mimic datagen_info.")
...
# 4. 메인 함수
# ============================================================================
# state replay와 mimic-ready source 생성 실습 파이프라인을 실행합니다.
def main() -> None:
