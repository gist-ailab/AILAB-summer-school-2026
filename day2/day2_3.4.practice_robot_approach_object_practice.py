...
def main():
    ...
    object_init_pos = (env.scene["object"].data.root_pos_w - env.scene["robot"].data.root_pos_w).clone()
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            # -- 환경 스텝 진행 (ManagerBasedEnv.step → (obs, extras) 2-튜플, 종료/보상 없음) --
