...
from task.lift.config import day2_3_joint_pos_env_cfg_practice

# ============================================================================
# 2. 미리 정의된 설정들 임포트
# ============================================================================
# TODO: Isaaclab asset franka panda cfg 임포트(FRANKA_PANDA_HIGH_PD_CFG)
...
@configclass
class FrankaCubeLiftEnvCfg(day2_3_joint_pos_env_cfg_practice.FrankaCubeLiftEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        self.actions.arm_action = DifferentialInverseKinematicsActionCfg(
            ...
            body_offset=DifferentialInverseKinematicsActionCfg.OffsetCfg(
                pos=(0.0, 0.0, 0.1034)  # z축 방향 오프셋 (그리퍼 길이)
            )
        )
