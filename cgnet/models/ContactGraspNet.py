...
from cgnet.models.build import MODELS
...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # /AILAB-summer-school-2025/cgnet -> /AILAB-summer-school-2025
CGNET_DIR = os.path.dirname(BASE_DIR)                  # /AILAB-summer-school-2025/cgnet
sys.path.append(CGNET_DIR)
